...
```
go get luyc-chain-bot/pkg/shutdown
```

## Documentation

`luyc-chain-bot/pkg/shutdown` documentation is available on [godoc](http://godoc.org/luyc-chain-bot/pkg/shutdown).

Both `ShutdownManagers` are also documented:
- [`PosixSignalManager`](http://godoc.org/luyc-chain-bot/pkg/shutdown/shutdownmanagers/posixsignal)
- [`AwsManager`](http://godoc.org/luyc-chain-bot/pkg/shutdown/shutdownmanagers/awsmanager)
...
import (
	...
	"luyc-chain-bot/pkg/shutdown"
	"luyc-chain-bot/pkg/shutdown/shutdownmanagers/awsmanager"
	"luyc-chain-bot/pkg/shutdown/shutdownmanagers/posixsignal"
)
